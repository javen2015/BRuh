...
function draw(){
    ...
    textSize(16);
    textAlign(LEFT);
    text("Your Name:",width/2-10,height/2 + 50);
    text("Your Age:",width/2,height/2);
    fill(0);
    text('Pick a background color',20,50);
    text('Enter your name:',width/2-230,height/2 + 123);
    text('Enter your age:',width/2-220,height/2 + 150);
    textSize(32);
    fill(255);
